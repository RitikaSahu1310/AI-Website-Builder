    ...
    return (
        <div className='relative min-h-screen bg-[#040404] text-white overflow-x-hidden'>
            ...
            <section className='pt-48 pb-24 px-6 text-center'>
                ...
                >
                    Discribe your idea and let AI generate a modern, responsive, production-ready website.
                </motion.p>

                <button
                    className='px-10 py-4 rounded-xl bg-white text-black font-semibold hover:scale-105 transition mt-12' onClick={() =>userData? navigate("/dashboard"):setOpenLogin(true)}
                >
                    {userData ? "Go to dashboard" : "Get Started"}
                </button>
            </section>
{!userData && <section className='max-w-7xl mx-auto px-6 pb-20'>
                    ...
                    {highlights.map((h, i) => (
                        ...
                        >
                            ...
                            <p className='text-sm text-zinc-400'>
                                GenWeb.ai builds real websites - clean code, animations, responsiveness, scalable structure.
                            </p>
                        </motion.div>
                    ))}
                </div>
