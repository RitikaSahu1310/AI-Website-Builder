...
const plans = [
  ...
  },
  {
    ...
    features: [
      "Everything in Pro",
      "High credit limit",
      "Unlimited website edits until credits last",
      "Client-ready website output",
      "Best for business projects"
    ],
    popular: false,
        ...
        {plans.map((p, i) => (
          ...
          >
            ...
            <motion.button
              ...
              className={`w-full py-3 rounded-xl font-semibold transition ${p.popular
